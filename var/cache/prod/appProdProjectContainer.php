...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('1P-sd9Lysh', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('r9OgUhP8sO', 0, 'UYChf-b5I26WiYyXip+soA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('X68PwJ88Mk', 0, 'UYChf-b5I26WiYyXip+soA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'livrogne_api', 'user' => 'root', 'password' => 'Livrogn8', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ee38a74b5ef45b28f9ebb384cf3fa05edd7d5daf5b7a5664cef289d2f3982a76');
    ...
    public function getFosRest_SerializerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['fos_rest.serializer'] = FOSRestBundleSerializerJMSSerializerAdapter_000000000b2de466000000005eabfb29683c7fe0d40fc92e647a726ef4df2787::staticProxyConstructor(
    ...
    {
        return $this->services['fos_rest.serializer.exception_normalizer.jms'] = new \FOS\RestBundle\Serializer\Normalizer\ExceptionHandler(new \FOS\RestBundle\Util\ExceptionValueMap(array('Symfony\\Component\\Security\\Core\\Exception\\BadCredentialsException' => true)), false);
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/'))), $this->get('event_dispatcher'));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('o8A4ZwEPn4', 0, 'UYChf-b5I26WiYyXip+soA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'validator.mapping.cache.prefix' => 'validator_47de5dca27251fa805f113cae6abb4817a67422e29f757ac50be158bb23ff46c',
...
class FOSRestBundleSerializerJMSSerializerAdapter_000000000b2de466000000005eabfb29683c7fe0d40fc92e647a726ef4df2787 extends \FOS\RestBundle\Serializer\JMSSerializerAdapter implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder59aca7b637f0b708039160 = null;
    private $initializer59aca7b637f11980882304 = null;
    private static $publicProperties59aca7b637eea195037408 = array(
        
    );
    public function serialize($data, $format, \FOS\RestBundle\Context\Context $context)
    {
        $this->initializer59aca7b637f11980882304 && $this->initializer59aca7b637f11980882304->__invoke($this->valueHolder59aca7b637f0b708039160, $this, 'serialize', array('data' => $data, 'format' => $format, 'context' => $context), $this->initializer59aca7b637f11980882304);
        return $this->valueHolder59aca7b637f0b708039160->serialize($data, $format, $context);
    }
    public function deserialize($data, $type, $format, \FOS\RestBundle\Context\Context $context)
    {
        $this->initializer59aca7b637f11980882304 && $this->initializer59aca7b637f11980882304->__invoke($this->valueHolder59aca7b637f0b708039160, $this, 'deserialize', array('data' => $data, 'type' => $type, 'format' => $format, 'context' => $context), $this->initializer59aca7b637f11980882304);
        return $this->valueHolder59aca7b637f0b708039160->deserialize($data, $type, $format, $context);
    }
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer59aca7b637f11980882304 = $initializer;
        return $instance;
    }
    public function __construct(\JMS\Serializer\SerializerInterface $serializer)
    {
        static $reflection;
        if (! $this->valueHolder59aca7b637f0b708039160) {
            $reflection = $reflection ?: new \ReflectionClass('FOS\\RestBundle\\Serializer\\JMSSerializerAdapter');
            $this->valueHolder59aca7b637f0b708039160 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\FOS\RestBundle\Serializer\JMSSerializerAdapter $instance) {
            unset($instance->serializer);
        }, $this, 'FOS\\RestBundle\\Serializer\\JMSSerializerAdapter')->__invoke($this);
        }
        $this->valueHolder59aca7b637f0b708039160->__construct($serializer);
    }
    public function & __get($name)
    {
        $this->initializer59aca7b637f11980882304 && $this->initializer59aca7b637f11980882304->__invoke($this->valueHolder59aca7b637f0b708039160, $this, '__get', ['name' => $name], $this->initializer59aca7b637f11980882304);
        if (isset(self::$publicProperties59aca7b637eea195037408[$name])) {
            return $this->valueHolder59aca7b637f0b708039160->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59aca7b637f0b708039160;
    ...
    {
        $this->initializer59aca7b637f11980882304 && $this->initializer59aca7b637f11980882304->__invoke($this->valueHolder59aca7b637f0b708039160, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer59aca7b637f11980882304);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59aca7b637f0b708039160;
    ...
    {
        $this->initializer59aca7b637f11980882304 && $this->initializer59aca7b637f11980882304->__invoke($this->valueHolder59aca7b637f0b708039160, $this, '__isset', array('name' => $name), $this->initializer59aca7b637f11980882304);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59aca7b637f0b708039160;
    ...
    {
        $this->initializer59aca7b637f11980882304 && $this->initializer59aca7b637f11980882304->__invoke($this->valueHolder59aca7b637f0b708039160, $this, '__unset', array('name' => $name), $this->initializer59aca7b637f11980882304);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59aca7b637f0b708039160;
    ...
    {
        $this->initializer59aca7b637f11980882304 && $this->initializer59aca7b637f11980882304->__invoke($this->valueHolder59aca7b637f0b708039160, $this, '__clone', array(), $this->initializer59aca7b637f11980882304);
        $this->valueHolder59aca7b637f0b708039160 = clone $this->valueHolder59aca7b637f0b708039160;
    }
    public function __sleep()
    {
        $this->initializer59aca7b637f11980882304 && $this->initializer59aca7b637f11980882304->__invoke($this->valueHolder59aca7b637f0b708039160, $this, '__sleep', array(), $this->initializer59aca7b637f11980882304);
        return array('valueHolder59aca7b637f0b708039160');
    }
    ...
    {
        $this->initializer59aca7b637f11980882304 = $initializer;
    }
    public function getProxyInitializer()
    {
        return $this->initializer59aca7b637f11980882304;
    }
    public function initializeProxy() : bool
    {
        return $this->initializer59aca7b637f11980882304 && $this->initializer59aca7b637f11980882304->__invoke($this->valueHolder59aca7b637f0b708039160, $this, 'initializeProxy', array(), $this->initializer59aca7b637f11980882304);
    }
    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder59aca7b637f0b708039160;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder59aca7b637f0b708039160;
    }
}
