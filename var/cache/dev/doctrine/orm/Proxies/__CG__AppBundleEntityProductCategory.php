...
class ProductCategory extends \AppBundle\Entity\ProductCategory implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ProductCategory' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\ProductCategory' . "\0" . 'categoryName', '' . "\0" . 'AppBundle\\Entity\\ProductCategory' . "\0" . 'price', '' . "\0" . 'AppBundle\\Entity\\ProductCategory' . "\0" . 'products', '' . "\0" . 'AppBundle\\Entity\\ProductCategory' . "\0" . 'isRemoved'];
        }
