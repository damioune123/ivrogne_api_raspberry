...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'firstname', 'lastname', 'username', 'password', 'plainPassword', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'role', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'userAccounts', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'rfidCard', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'authTokens', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'nefews', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'godfather', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'promotion', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'isRemoved', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'authenticatedMoneyFlows'];
        }
    ...
    public function getAuthenticatedMoneyFlows()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAuthenticatedMoneyFlows', []);

        return parent::getAuthenticatedMoneyFlows();
    }
    ...
    public function setAuthenticatedMoneyFlows($authenticatedMoneyFlows)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAuthenticatedMoneyFlows', [$authenticatedMoneyFlows]);

        return parent::setAuthenticatedMoneyFlows($authenticatedMoneyFlows);
    }
